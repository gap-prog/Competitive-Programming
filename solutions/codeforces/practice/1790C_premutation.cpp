// CodeForces Problem Link: https://codeforces.com/problemset/problem/1790/C
...
void solve() {
  int n; cin >> n;
  vector<vector<int>> permutations(n, vector<int>(n - 1));
  FOR(i, n) {
